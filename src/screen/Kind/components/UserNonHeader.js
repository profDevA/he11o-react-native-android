...
class UserNonHeader extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            imageUrl:
            ...
            return (
                <ScrollView style={{backgroundColor:'white'}}>
                    <View>
                        ...
                        <View style={{height:260, alignItems:'center', backgroundColor:'#F7F8F9'}}>
                            ...
                            >
                                <View style={{height:100, width:100, marginTop:-60, borderRadius:30, alignSelf:'center', backgroundColor:'#EFEEEF'}}>
                                    <Image source={{uri: users.user_url ? IMAGE_BASE_URL+users.user_url : this.state.imageUrl}}
                                            style={{
                                                borderRadius:30,
                                                width:100,
                                                height:100
                                ...
                                <View style={{flexDirection:'row', borderTopColor:'#E0E1E0', borderTopWidth:0.5, marginTop:40, flex: 1}}>
                                    <View style={{borderRightColor:'#BCBCBC', borderRightWidth:0.5, width:'33%', height:20, marginTop:10}}>
